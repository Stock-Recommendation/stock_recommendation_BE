...
def create() -> list:
    ...
    for stock in stocks:
        ...
        st = Stock(ticker=ticker, stock_name=stock_name,
                   ...
                   tweet_ids=tweet_ids, predicted_price_1d=predicted_price_1d, predicted_price_1w=predicted_price_1w, predicted_price_1m=predicted_price_1m, predicted_price_3m=predicted_price_3m)
