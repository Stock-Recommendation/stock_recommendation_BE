...
def create() -> list:
    ...
    for stock in stocks:
        ...
        predicted_price = process(stock)
        # predicted_price_1d, predicted_price_1w, predicted_price_1m, predicted_price_3m = predicted_price[0], predicted_price[
        #     1], predicted_price[2], predicted_price[3]
        predicted_price_1d, predicted_price_1w, predicted_price_1m, predicted_price_3m = 1,2,3,4

        st = Stock(ticker=ticker, stock_name=stock_name,
                   market_cap=market_cap, current_price=current_price, predicted_price_1d=predicted_price_1d, predicted_price_1w=predicted_price_1w, predicted_price_1m=predicted_price_1m, predicted_price_3m=predicted_price_3m)
